---
name: skill-dev
description: Master skill for Claude Code skill development (13 sub-skills). Covers: official-docs, skill-creation, skill-tree-protocol, description-writing, frontmatter-reference, progressive-disclosure, fork-terminal-pattern, hooks-observability, community-patterns, skill-validation, indydevdan-tutorial, ecosystem-discovery, skill-storage. Invoke for creating skills, understanding skill architecture, writing descriptions, skill tree design, or cataloguing skills.
allowed-tools: Read, Skill, Task, Glob, Grep, Write, Edit, Bash
---
...
| **skill-storage** | SQLite + FTS5 storage, embeddings, cataloguing infrastructure | `subskills/skill-storage.md` |
...
| "Catalogue skills" | skill-storage |
| "Search skills semantically" | skill-storage |
